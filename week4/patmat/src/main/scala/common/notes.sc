...
val fruits = "pineapple" :: "apple" :: "banana" :: Nil

msort[String](fruits)((x, y) => x.compareTo(y) < 0)
...
msortOrd[Int](list3)(Ordering.Int)

msortOrd[String](fruits)(Ordering.String)
...
msortOrdImpl[Int](list3)

msortOrdImpl[String](fruits)